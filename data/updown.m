...
h = legend([plotQM,...
    ...
    'Original QM+phn', ...
    ['Shifted QM+phn, reducing c by 0.0733 \AA $c_{opt}$=' '$\AA$'], ...
    ['X6 potential $c_{opt}$='  '$\AA$'], ...
    ['$\textbf{Z}\exp(\textbf{A}r)$ $\textbf{C}_6$,$R_0$ $c_{opt}$='  '$\AA$'], ...
    ['$\textbf{Z}\exp(\textbf{A}r)\cdot\exp(-\textbf{C}r^\textbf{n}+\textbf{D}r)$ $\textbf{C}_6$,$R_0$ $c_{opt}$=' '$\AA$'], ...
    ['$\textbf{Z}\exp(\textbf{A}r)\cdot\exp(-\textbf{C}r^\textbf{n}+\textbf{D}r)$ $\textbf{C}_6$,$R_0$ $c_{opt}$=' '$\AA$']);

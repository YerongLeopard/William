...
figure; hold on;
rr2 = 0.5: 0.01: 6;
single_para = [29.8268 -4.0996 8.6854 0 0 0 1];
...
h = legend([plot_EXP1, ...
    plot_repEXP1, ...
    plot_atrEXP1], ...
    'fitted EXP1 $\textbf{Z}\exp(\textbf{A}r)$ $\textbf{C}_6$,$R_0$', ...
    'repulsive part: fitted $\textbf{Z}\exp(\textbf{A}r)$ $\textbf{C}_6$,$R_0$', ...
    'LG part: fitted $\textbf{Z}\exp(\textbf{A}r)$ $\textbf{C}_6$,$R_0$'  ...
    );
...
rr2=0.5: 0.01: 6;
full_para=[38.7635 -3.8605 8.6515 -0.1999 0.7387 -0.4612  1];
ry=repFUNC(full_para, rr);
plot_repEXP2 = plot(rr ,ry, 'b*');



ay = atrFUN([937.7635 3.85], rr); 
...
h = legend([plot_EXP2, ...
    plot_repEXP2, ...
    plot_atrEXP2], ...
    'fitted $\textbf{Z}\exp(\textbf{A}r)\cdot\exp(-\textbf{C}r^\textbf{n}+\textbf{D}r)$ $\textbf{C}_6$,$R_0$', ...
    'repulsive part: fitted $\textbf{Z}\exp(\textbf{A}r)\cdot\exp(-\textbf{C}r^\textbf{n}+\textbf{D}r)$ $\textbf{C}_6$,$R_0$', ...
    'LG part: full fitted $\textbf{Z}\exp(\textbf{A}r)\cdot\exp(-\textbf{C}r^\textbf{n}+\textbf{D}r)$ $\textbf{C}_6$,$R_0$');
